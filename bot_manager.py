...
class TradingBotManager:
    ...
    def start_bot(self, background: bool = False) -> bool:
        ...
        try:
            ...
            if background:
                ...
                print(f"Bot démarré en arrière-plan avec PID: {self.bot_process.pid}")
            ...
            if os.path.exists(self.stats_file):
                with open(self.stats_file, 'r') as f:
                    ...
                    if 'uptime_seconds' in stats:
                        status['uptime'] = self._format_uptime(stats['uptime_seconds'])
    ...
    def show_status(self):
        ...
        if status['is_running']:
            print(f"État: ✅ EN COURS D'EXÉCUTION")
        ...
        if status['stats']:
            ...
            if 'trading_summary' in stats:
                ...
                if summary:
                    ...
                    print(f"Ordres complétés: {summary.get('filled_orders', 0)}")
                    print(f"Symboles surveillés: {summary.get('subscribed_symbols', [])}")
    ...
    def show_logs(self, lines: int = 50):
        ...
        try:
            ...
            print(f"Dernières {len(recent_lines)} lignes du log:")
            print("-" * 60)
    ...
    def monitor(self, refresh_interval: int = 30):
        ...
        try:
            while True:
                ...
                print(f"\nMise à jour automatique toutes les {refresh_interval}s")
